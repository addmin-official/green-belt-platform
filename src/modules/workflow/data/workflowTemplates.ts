...
export const initialWorkflowSteps: WorkflowStep[] = [
  {
    ...
    detail: { en: 'The trader uploads the cargo manifest into IDG portal using cryptographic biosecurity signature verification.', ar: 'يقوم المستورد برفع تفاصيل الشحنة عبر البوابة بختم وبصمة إلكترونية بايومترية مشفرة صفري ثقة.', ku: 'هاوردەکار وەسفی گشتی شتوومەک پاشەکەوت دەکات لە ڕێگەی مۆری دیجیتاڵیی هێمن.' }
  },
  {
    id: 'step-2',
  ...
  },
  {
    ...
    detail: { en: 'Verifies dual-use industrial chemical reagents or alloys matching military security authorization registers.', ar: 'فحص مسبق للمواد الكيميائية والأجهزة الحساسة لمنع دخول المواد الخطرة دون تفويض.', ku: 'پشکنینی تەواوی ماددە جۆربەجۆرەکانی پیشەسازی پێش دانی ڕێپێدانی تێپەڕبوون.' }
  },
  {
    id: 'step-6',
