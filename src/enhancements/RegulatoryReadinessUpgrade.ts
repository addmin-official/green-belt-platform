...
const readinessItems = [
  {
    ...
    body: 'ڕێستورانت، پڕۆسەی گواستنەوە، شوێنی پرۆسەکردن و تاقیگە دەبێت ناسنامە و دۆخی پەسەندکردنی ڕوونیان هەبێت.',
  },
  {
...
const regulatedRoles = [
  ...
  'کۆکردنەوە و پڕۆسەی گواستنەوەی پەسەندکراو',
...
function buildRegulatorySection(): HTMLElement {
  ...
  section.innerHTML = `
    ...
    <div class="regulatory-readiness__footer">
      <p>
        سەرچاوەی فێربوون: پەڕەی Regulated Businesses ـی CalRecycle، کە دامەزراوە، پڕۆسەی گواستنەوە، پەیینسازی، ڕاپۆرتکردن و پڕۆسەی مۆڵەتکردن جیا دەکاتەوە.
      </p>
